...
if (document.querySelector('.info-slider')) {
	let mainslider = new Swiper('.info-slider__body', {
		...
		// Dotts
		pagination: {
			el: '.info-slider__dots',//куда отправляю точки
			clickable: true,
		},
...
if (document.querySelector('.speeches-slider')) {
	let mainslider = new Swiper('.speeches-slider__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Dotts
		pagination: {
			el: '.speeches-slider__dots',//куда отправляю точки
			clickable: true,
		},

		// Arrows
		navigation: {
			nextEl: '.speeches-slider__arrow_next',
			prevEl: '.speeches-slider__arrow_prev',
		},
...
// learn more для services

$(".items2 .items2__link").click(function () {
   $(this).parents(".items2__column").addClass("super-column"); //добавляем класс текущей (нажатой)
})
$(".items2 .items2__close").click(function () {
   $(this).parents(".items2__column").removeClass("super-column"); //добавляем класс текущей (нажатой)
})
